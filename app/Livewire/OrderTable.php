...
final class OrderTable extends PowerGridComponent
{
    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
           ...
           /** Example of custom column using a closure **/
            ->addColumn('status_lower', fn (Order $model) => strtolower(e($model->status)))

            ->addColumn('total_price')
            ->addColumn('customer_id')
            ->addColumn('shipping_address_id')
            ->addColumn('billing_address_id')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Shipping address id', 'shipping_address_id'),
            Column::make('Billing address id', 'billing_address_id'),
