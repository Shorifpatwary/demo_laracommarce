                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <input type="number" pattern="[0-9]*"
                      ...
                      value="{{ old('selling_price') }}" id="selling_price" required="">
                    @error('selling_price')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <input type="number" pattern="[0-9]*"
                      class="form-control @error('selling_price') is-invalid @enderror" name="discount_price"
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="number" pattern="[0-9]*"
                      ...
                      value="{{ old('stock_quantity') }}" id="stock_quantity">
